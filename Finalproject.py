...
#CSCI 431
#Finalproject.py
#Thos program uses  a data that is read from a spreadsheet
#
#
...
################################################
# 
# def getCombo1(Dat,Comb):
#
#     AirCraft=[]
#     i=0
#     while i< len(CarrierList):
#         extra=["",0,0,0,0,0]
#         extra[0]=CarrierList[i]
#         Carriers.append(extra)
#         i+=1

# Months=sorted(Months, key=operator.itemgetter(5), reverse=True)
# Month=Months[0][0]
# Month2=Months[1][0]
# Month3=Months[2][0]
def get_man():
    ...
    #data_filt4=((mandata["DISTANCE_RANGE"]==manVar1.get()) & (mandata["MONTH"]==manVar2.get()) & (mandata["AIRCRAFT_TYPE"]==int(manVar3.get())))
    if manVar1.get() != "NONE":
        data_filt4=(mandata["DISTANCE_RANGE"]==manVar1.get())
    ...
    # data_filt4=((mandata["DISTANCE_RANGE"]==manVar1.get()) & (mandata["MONTH"]==manVar2.get()) & (mandata["DEST_STATE_NM"]==manVar4.get()))
    # mandata=mandata[data_filt4]
    if mandata.empty:
        ...
        mandata=mandata.sort_values(by=['RATING','SEATS'],ascending=False)
        mandata = mandata[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING"]]
        ...
        mandata=mandata.iloc[0:3,:]
        resultText.insert(tk.END,mandata.to_string(index=False))
        #resultText.insert(tk.END, str(mandata.loc[:5,["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH"]]))
        resultText.pack()
...
def create_Auto():
    ...
    data["SEATS"]=data["SEATS"]/data["DEPARTURES_PERFORMED"]
    ...
    Carfilt=(Cardata["CARRIER_NAME"]==Car)# creates a filter for the best month
    ...
    DRdata= DRdata[DRdata["DISTANCE_RANGE"]==DRange]
    ...
    Monthdata = Monthdata[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_MONTH","AVERAGE_RATING_FOR_MONTH"]]# gets only the colums that i want
    Monthdata2 = Monthdata2[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_MONTH","AVERAGE_RATING_FOR_MONTH"]]# gets only the colums that i want
    Monthdata3 = Monthdata3[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_MONTH","AVERAGE_RATING_FOR_MONTH"]]# gets only the colums that i want

    Cardata = Cardata[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_CARRIER","AVERAGE_RATING_FOR_CARRIER"]]# gets only the colums that i want
    Cardata2 = Cardata2[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_CARRIER","AVERAGE_RATING_FOR_CARRIER"]]# gets only the colums that i want
    Cardata3 = Cardata3[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_CARRIER","AVERAGE_RATING_FOR_CARRIER"]]# gets only the colums that i want

    DRdata = DRdata[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","DISTANCE_RANGE","AVERAGE_SUCCESS_FOR_DISTANCE","AVERAGE_RATING_FOR_DISTANCE"]]# gets only the colums that i want
    DRdata2 = DRdata2[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","DISTANCE_RANGE","AVERAGE_SUCCESS_FOR_DISTANCE","AVERAGE_RATING_FOR_DISTANCE"]]# gets only the colums that i want
    DRdata3 = DRdata3[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","DISTANCE_RANGE","AVERAGE_SUCCESS_FOR_DISTANCE","AVERAGE_RATING_FOR_DISTANCE"]]# gets only the colums that i want

    DSdata = DSdata[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_DEST_STATE","AVERAGE_RATING_FOR_DEST_STATE"]]# gets only the colums that i want
    DSdata2 = DSdata2[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_DEST_STATE","AVERAGE_RATING_FOR_DEST_STATE"]]# gets only the colums that i want
    DSdata3 = DSdata3[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_DEST_STATE","AVERAGE_RATING_FOR_DEST_STATE"]]# gets only the colums that i want

    DCdata = DCdata[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_DEST_CITY","AVERAGE_RATING_FOR_DEST_CITY"]]# gets only the colums that i want
    DCdata2 = DCdata2[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_DEST_CITY","AVERAGE_RATING_FOR_DEST_CITY"]]# gets only the colums that i want
    DCdata3 = DCdata3[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_DEST_CITY","AVERAGE_RATING_FOR_DEST_CITY"]]# gets only the colums that i want

    OSdata = OSdata[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","DISTANCE_RANGE","AVERAGE_SUCCESS_FOR_ORIGIN_STATE","AVERAGE_RATING_FOR_ORIGIN_STATE"]]# gets only the colums that i want
    OSdata2 = OSdata2[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","DISTANCE_RANGE","AVERAGE_SUCCESS_FOR_ORIGIN_STATE","AVERAGE_RATING_FOR_ORIGIN_STATE"]]# gets only the colums that i want
    OSdata3 = OSdata3[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","DISTANCE_RANGE","AVERAGE_SUCCESS_FOR_ORIGIN_STATE","AVERAGE_RATING_FOR_ORIGIN_STATE"]]# gets only the colums that i want

    OCdata = OCdata[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_ORIGIN_CITY","AVERAGE_RATING_FOR_ORIGIN_CITY"]]# gets only the colums that i want
    OCdata2 = OCdata2[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_ORIGIN_CITY","AVERAGE_RATING_FOR_ORIGIN_CITY"]]# gets only the colums that i want
    OCdata3 = OCdata3[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","RATING","AVERAGE_SUCCESS_FOR_ORIGIN_CITY","AVERAGE_RATING_FOR_ORIGIN_CITY"]]# gets only the colums that i want

    ATdata = ATdata[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","AIRCRAFT_TYPE","RATING","AVERAGE_SUCCESS_FOR_AIR_CRAFT","AVERAGE_RATING_FOR_AIR_CRAFT"]]# gets only the colums that i want
    ATdata2 = ATdata2[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","AIRCRAFT_TYPE","RATING","AVERAGE_SUCCESS_FOR_AIR_CRAFT","AVERAGE_RATING_FOR_AIR_CRAFT"]]# gets only the colums that i want
    ATdata3 = ATdata3[["SEATS","DISTANCE","CARRIER_NAME","ORIGIN_CITY_NAME","DEST_CITY_NAME","MONTH","AIRCRAFT_TYPE","RATING","AVERAGE_SUCCESS_FOR_AIR_CRAFT","AVERAGE_RATING_FOR_AIR_CRAFT"]]# gets only the colums that i want

    MonthresultText = tk.Text(page1,height=30, width=180)
    ...
    CarresultText = tk.Text(page8,height=30, width=180)
    ...
    DRresultText = tk.Text(page7,height=30, width=180)
    ...
    DCresultText = tk.Text(page3,height=30, width=180)
    ...
    OSresultText = tk.Text(page4,height=30, width=180)
    ...
    quitButton.grid(row=0,column=100)
...
stars= (data["DEPARTURES_PERFORMED"] * data["SEATS"])*data["My_Ratio"] # my prototype ratio
...
flightlist= data.values.tolist()
 #Distance, Carrier, Origin City, Destination City, Aircraft,Month, State
CarrierList=data.CARRIER_NAME.unique()
MonthList= data.MONTH.unique()
DestSList= data.DEST_STATE_NM.unique()
DestCList= data.DEST_CITY_NAME.unique()
OCList= data.ORIGIN_CITY_NAME.unique()
AirList= data.AIRCRAFT_TYPE.unique()
OSList= data.ORIGIN_STATE_NM.unique()
DRList= data.DISTANCE_RANGE.unique()
...
for AirT in AirCraft:
    ...
    AirT[5]=AirT[3]*AirT[4]#Temp score of Avg seats * Ratio


for M in Months:
    data.loc[data.MONTH ==M[0], 'AVERAGE_SUCCESS_FOR_MONTH'] = M[4]
    data.loc[data.MONTH ==M[0], 'AVERAGE_RATING_FOR_MONTH'] = M[5]

for C in Carriers:
    data.loc[data.CARRIER_NAME ==C[0], 'AVERAGE_SUCCESS_FOR_CARRIER'] = C[4]
    data.loc[data.CARRIER_NAME ==C[0], 'AVERAGE_RATING_FOR_CARRIER'] = C[5]

for OS in OriginS:
    data.loc[data.ORIGIN_STATE_NM ==OS[0], 'AVERAGE_SUCCESS_FOR_ORIGIN_STATE'] = OS[4]
    data.loc[data.ORIGIN_STATE_NM ==OS[0], 'AVERAGE_RATING_FOR_ORIGIN_STATE'] = OS[5]

for OC in OriginC:
    data.loc[data.ORIGIN_CITY_NAME == OC[0], 'AVERAGE_SUCCESS_FOR_ORIGIN_CITY'] = OC[4]
    data.loc[data.ORIGIN_CITY_NAME == OC[0], 'AVERAGE_RATING_FOR_ORIGIN_CITY'] = OC[5]

for DS in DestS:
    data.loc[data.DEST_STATE_NM == DS[0], 'AVERAGE_SUCCESS_FOR_DEST_STATE'] = DS[4]
    data.loc[data.DEST_STATE_NM == DS[0], 'AVERAGE_RATING_FOR_DEST_STATE'] = DS[5]

for DiRa in DistanceR:
    data.loc[data.DISTANCE_RANGE == DiRa[0], 'AVERAGE_SUCCESS_FOR_DISTANCE'] = DiRa[4]
    data.loc[data.DISTANCE_RANGE == DiRa[0], 'AVERAGE_RATING_FOR_DISTANCE'] = DiRa[5]

for DC in DestC:
    data.loc[data.DEST_CITY_NAME == DC[0], 'AVERAGE_SUCCESS_FOR_DEST_CITY'] = DC[4]
    data.loc[data.DEST_CITY_NAME == DC[0], 'AVERAGE_RATING_FOR_DEST_CITY'] = DC[5]

for AirT in AirCraft:
    data.loc[data.AIRCRAFT_TYPE == AirT[0], 'AVERAGE_SUCCESS_FOR_AIR_CRAFT'] = AirT[4]
    data.loc[data.AIRCRAFT_TYPE == AirT[0], 'AVERAGE_RATING_FOR_AIR_CRAFT'] = AirT[5]
